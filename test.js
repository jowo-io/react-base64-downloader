...
describe('invokes saveFile when <Base64Downloader /> is clicked', () => {
    ...
    const mountedComponent = mount(
        <Base64Downloader {...requiredProps} base64={base64} />
    );
    ...
    test('Renders without crashing', () => {
        expect(
            mountedComponent.find(Base64Downloader.defaultProps.Tag).text()
        ).toEqual(requiredProps.children);
    });
...
describe('invokes saveFile when <Base64Downloader /> is clicked', () => {
    ...
    const mountedComponent = mount(
        <Base64Downloader {...allProps} base64={base64} />
    );
...
describe('throws error when <Base64Downloader /> is clicked and base64 is invalid', () => {
    ...
    test('Renders without crashing', () => {
        ...
        expect(mountedComponent.find(allProps.Tag).text()).toEqual(
            allProps.children
        );
    });
